...
const runtimeFallbacks: Record<string, string> = {
  ...
  'builder.provider_openai': 'OpenAI',
  'builder.provider_openrouter': 'OpenRouter',
  ...
  'builder.route_openrouter_done': 'Este plan se armo con OpenRouter.',
  ...
  'dashboard.build_openrouter': 'Armar con OpenRouter',
